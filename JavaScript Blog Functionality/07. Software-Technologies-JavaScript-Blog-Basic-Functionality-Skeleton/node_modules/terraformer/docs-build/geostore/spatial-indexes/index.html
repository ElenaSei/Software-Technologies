...
<main class="docs main-content" id="main-content">
    ...
    <div class='semantic-toc'>
        <ol>
            <li><a href='#existing-spatial-indexes'>Existing Spatial Indexes</a></li>
            <li><a href='#writing-a-spatial-index'>Writing a Spatial Index</a>
                <ol>
                    <li><a href='#methods'>Methods</a>
                        <ol>
                            <li><a href='#new-spatialindex'>new SpatialIndex()</a></li>
                            <li><a href='#spatialindexinsert'>SpatialIndex.insert(geojson | envelope, id, callback)</a>
                            </li>
                            <li><a href='#spatialindexremove'>SpatialIndex.remove(geojson | envelope, id, callback)</a>
                            </li>
                            <li><a href='#spatialindexsearch'>SpatialIndex.search(geojson | envelope, callback)</a></li>
                            <li><a href='#spatialindexwithin'>SpatialIndex.within(geojson | envelope, callback)</a>
    </div>

    <p>Spatial Indexes are an extremely important part of the GeoStore. Spatial Indexes allow for very quick elimination
        of <code>Features</code> and are part of the core of the GeoStore.</p>
    ...
    <ul>
        <li><a href="https://github.com/esri/terraformer-geostore-rtree">RTree</a> - RTree Index, works in Node.js and
            the browser
        </li>
    </ul>
    <h2>
    ...
    <p>Spatial Indexes are designed for searching spatial data, whether in 2D or 3D. The Terraformer GeoStore platform
        has defined a set of indexes that allow for multiple spatial index types to be used. As long as the methods are
        asyncronous and conform to the Terraformer GeoStore interface, any type of spatial index can be used.</p>
    <h3>
    ...
    <p>Instantiating a <code>SpatialIndex</code> should return a new object containing method signatures conforming to
        the <code>SpatialIndex</code> interface.</p>

    <p>You can pass any needed arguments while instantiating.</p>

    <p><em>Example:</em></p>
    <pre class="highlight javascript"><code><span class="kd">var</span> <span class="nx">si</span> <span
            class="o">=</span> <span class="k">new</span> <span class="nx">SpatialIndex</span><span class="p">({</span>
...
<span class="p">});</span>
    ...
    <p>Add a <code>geojson</code> object or <code>envelope</code> to a <code>SpatialIndex</code>. It is important to
        include an <code>id</code>, as this is the key that is returned from searches.</p>
    ...
    <table>
        ...
        <tbody>
        <tr>
            <td><a href="/glossary/#geojson"><code>GeoJSON</code></a> <em>or</em> <a href="/glossary/#envelope"><code>Envelope</code></a>
            </td>
    ...
    <p><em>Example:</em></p>
    <pre class="highlight javascript"><code><span class="nx">si</span><span class="p">.</span><span
            class="nx">insert</span><span class="p">(</span><span class="nx">geojson</span><span
            class="p">,</span> <span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span
            class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span
...
<span class="p">});</span>
    ...
    <p><em>Example:</em></p>
    <pre class="highlight javascript"><code><span class="nx">si</span><span class="p">.</span><span
            class="nx">remove</span><span class="p">(</span><span class="nx">geojson</span><span
            class="p">,</span> <span class="nx">id</span><span class="p">,</span> <span class="kd">function</span> <span
            class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span
            class="p">)</span> <span class="p">{</span>
  <span class="c1">// Node.js style callback</span>
<span class="p">});</span>
    ...
    <p>Searches for any <code>id</code>&rsquo;s that can contain the <code>geojson</code> or <code>envelope</code>
        passed in. These are returned as an <code>Array</code>.</p>
    ...
    <p><em>Example:</em></p>
    <pre class="highlight javascript"><code><span class="nx">si</span><span class="p">.</span><span
            class="nx">search</span><span class="p">(</span><span class="nx">geojson</span><span
...
<span class="p">});</span>
    ...
    <p>Searches for any <code>id</code>&rsquo;s that are within the <code>geojson</code> or <code>envelope</code> passed
        in. These are returned as an <code>Array</code>.</p>
